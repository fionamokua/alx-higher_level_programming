...
This folder contains an introduction to the python programming language.
...
(From your terminal, convert the file created to `SCRIPT` i.e: chmod u + x basically making the file executable by giving it executable permissions`)
